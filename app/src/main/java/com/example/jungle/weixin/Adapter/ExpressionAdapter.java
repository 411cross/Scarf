...
public class ExpressionAdapter extends BaseAdapter{
    ...
    private static int[] mImageIds = new int[] {R.drawable.d_aini,R.drawable.d_baibai, R.drawable.d_beishang,
            ...
            R.drawable.f_jiong,R.drawable.f_shenma,R.drawable.f_v5,R.drawable.f_xi,
            R.drawable.h_buyao,R.drawable.h_good,R.drawable.h_lai,R.drawable.h_haha,R.drawable.h_ok,R.drawable.h_ruo, R.drawable.h_woshou,
