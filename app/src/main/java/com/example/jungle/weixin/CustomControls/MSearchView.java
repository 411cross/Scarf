...
public class MSearchView extends LinearLayout {
    ...
    private Toolbar search_block; // 搜索框布局
    ...
    public MSearchView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    ...
    public MSearchView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
              ...
              listView.setVisibility(VISIBLE);
                if ( cursor.getCount() != 0&&listView.getVisibility()==VISIBLE) {
    ...
    private void queryData(String tempName) {
        ...
        if (tempName.equals("") && cursor.getCount() != 0&&listView.getVisibility()==VISIBLE) {
            tv_clear.setVisibility(VISIBLE);
        } else {
            tv_clear.setVisibility(INVISIBLE);
        }
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        Log.i(TAG, "initAttrs: "+attrs.toString());
        // 控件资源名称
        ...
        Log.i(TAG, "initAttrs: "+textSizeSearch.toString());
    ...
    private void initView() {
        ...
        // 3. 搜索框背景颜色
        search_block = (Toolbar) findViewById(R.id.search_block);
